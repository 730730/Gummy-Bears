/**Version 0.006*/ var GmB = {cantidad: 0, perSec: 1};
...
function save() {
     localStorage['GmB0.006'] = GmB.cantidad;
     localStorage['GmBPs0.006'] = GmB.perSec;
     localStorage['costoUpgrade0.006'] = upg.precio;
     localStorage['cantidadUpgrade0.006'] = upg.cantidad;
}
...
function load() {
    ...
    GmB.cantidad = parseInt(localStorage['GmB0.006']);
    GmB.perSec = parseInt(localStorage['GmBPs0.006']);
    upg.precio = parseInt(localStorage['costoUpgrade0.006']);
    upg.cantidad = parseInt(localStorage['cantidadUpgrade0.006']);
    update();
}
...
function deleteSave() {
    ...
    if (alertaSave2 === true) {
        localStorage['GmB0.006'] = 0;
        localStorage['GmBPs0.006'] = 1;
        localStorage['costoUpgrade0.006'] = 10;
        localStorage['cantidadUpgrade0.006'] = 0;
        load();
    }
}
